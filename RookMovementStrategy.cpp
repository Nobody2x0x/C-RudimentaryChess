...
RookMovementStrategy::RookMovementStrategy(PieceColor pieceColor)
{
	this->pieceColor = pieceColor;
}

bool RookMovementStrategy::canMove(const Board& board, const Position& from, const Position& to) const
{
...
std::vector<Position> RookMovementStrategy::getPossibleMoves(const Position& currentPosition, const Board& board) const
{
...
std::unique_ptr<MovementStrategy> RookMovementStrategy::clone() const
{
	return std::make_unique<RookMovementStrategy>(*this);
}
