...
#include "Board.h"
BishopMovementStrategy::BishopMovementStrategy(PieceColor pieceColor)
{
	this->pieceColor = pieceColor;
}

bool BishopMovementStrategy::canMove(const Board& board, const Position& from, const Position& to) const
{
...
std::vector<Position> BishopMovementStrategy::getPossibleMoves(const Position& currentPosition, const Board& board) const
{
...
std::unique_ptr<MovementStrategy> BishopMovementStrategy::clone() const
{
	return std::make_unique<BishopMovementStrategy>(*this);
}
